		...
		<div class="top-nav">
			<div class="container">
				<div class="row">
					<div class="col-lg-6">
						<div class="logo">
							<a href="admin.html"> <img src='img/logo/m_blacklogo.png'
								alt="">
							</a>
						</div>
					</div>
							...
							<table style="margin-left: auto; margin-right: auto;">
								...
								<tr>
									...
									<tr style="margin-bottom: 20px;">
										<td>Birthday</td>
										<td style="padding-bottom: 20px"><select
										name="user_birth_year" size="5">
									...
									<td style="padding-bottom: 20px"><select
										name="user_birth_month" size="5" style="margin-bottom: 20px">
										...
										<td style="padding-bottom: 20px"><select
										name="user_birth_day" style="margin-bottom: 20px">
