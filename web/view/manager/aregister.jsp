                                                ...
                                                <form action="manageraddimpl.mc" method="post" class="ra-form">
                                                        <table style="margin-left: auto; margin-right: auto;">
                                                                <tr>
                                                                        ...
                                                                        <td>
                                                                                <button id="aid_check_btn" class="genric-btn info small" type="button" style="margin-bottom:30px">중복확인</button>
                                                                        </td>
                                                                        <td>
                                                                                <div class="aa">
                                                                ...
                                                                <tr>
                                                                        ...
                                                                        <td colspan="3">
                                                                                <div>
                                                                                        <input type="password" name="manager_pwd" id="manager_pwd" placeholder="Password">
                                                                                </div>
                                                                        </td>
                                                                </tr>
                                                                <tr>
                                                                ...
                                                                <tr>
                                                                        ...
                                                                        <td colspan="3">
                                                                                <div>
                                                                                        <input type="text" name="manager_address" placeholder="ex) 서울시 강남구 서초동">
                                                                                </div>
                                                                        </td>
                                                                </tr>
                                                                <tr>
                                                                        ...
                                                                        <td colspan="3">
                                                                                <div>
                                                                                        <input type="text" name="manager_phone" placeholder="ex) 010-000-0000">
                                                                                </div>
                                                                        </td>
                                                                </tr>
                                                                <tr>
                                                                        ...
                                                                        <td colspan="3">
                                                                                <div>
                                                                                        <input type="text" name="manager_nickname" placeholder="Nickname">
                                                                                </div>
                                                                        </td>
                                                                </tr>
                                                                ...
                                                                <tr>
                                                                        ...
                                                                        <td colspan="3">
                                                                                <div class="input_field mb-20">
                                                                                        <input type="text" name="manager_email" placeholder="ex) xxx@eody.com">
                                                                                </div>
                                                                        </td>
                                                                </tr>
                                                                <tr>
                                                                        <td>gender</td>
                                                                        <td colspan="3">
                                                                                <input type="radio" name="manager_gender" value="m" style="width:25px; height:25px;"/>&nbsp; man 
                                                                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                                                <input type="radio" name="manager_gender" value="w" style="width:25px; height:25px;"/>&nbsp; woman</td>
                                                                </tr>
                                                                <!-- <tr><td></td><td></td></tr> -->
                                                        </table>
                        ...
                        <div class="footer-text">
                                <div class="row">
                                        <div class="col-lg-4">
                                                <div class="ft-about">
                                                        <div class="logo">
                                                                <a href="#"> <img src='img/m_blacklogo.png' alt="">
                                                                </a>
                                                        </div>
                                                        <p>
