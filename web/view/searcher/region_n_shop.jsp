...
<body>
        ...
        <!--/ bradcam_area  -->
            <div class="explorer_europe list_wrap">
				<div class="container">
               	 	<div class="bradcam_text text-center">  <h2>Choose the region</h2><br><br>  </div>
                	     
								<div class="row">
									<c:forEach var="h" items="${regions }" varStatus="vs">
										<div class="col-xl-4 col-lg-3 col-md-3">
											<div class="single_explorer">
												<div class="thumb">
													<img src="view/searcher/img/regions/${h.h_img }" width="250px"
													height="200px">
												</div>
												<div class="explorer_bottom d-flex">
													<div class="explorer_info">
														<form id="listing${vs.index }" action="listing.mc" method="post">
														<input type="hidden" name="h_name" value="${h.h_name }">
														<h3><a href="javascript:{}" onclick="document.getElementById('listing${vs.index }').submit();">${h.h_name }</a></h3>
														</form>
													</div>
												</div>
											</div>
		...
		<c:choose>
			<c:when test="${centerpage == null}">
				<jsp:include page="nonlist.jsp"></jsp:include>
			</c:when>
			<c:otherwise>
        ...
        <script src="view/searcher/js/mail-script.js"></script>
                ...
                <script src="view/searcher/js/regionlist.js?ver=41"></script>
